...
knitr::opts_knit$set(root.dir = "/Volumes/Group Kok/Ariane /Ariane_Triple-B/Data/Clinical/Projects/BMI project/Final data files")
setwd("/Volumes/Group Kok/Ariane /Ariane_Triple-B/Data/Clinical/Projects/BMI project/Final data files")
tonicdf <- read.csv ("TONIC12_clinicaldata_BMIproject_20251020.csv")
>>>>>>> 23be80055b0c0fe0374172376de91664cc93ad20
```
...
```{r}
wilcox.test (os_days ~ BMI_grouped, correct = FALSE, data = tonicdf_filtered)

#analyse BMI continuous
cor.test(tonicdf_filtered$os_days, tonicdf_filtered$BMI, 
...
=======
```{r setup, include=FALSE}
knitr::opts_knit$set(root.dir = "/Volumes/Group Kok/Ariane /Ariane_Triple-B/Data/Clinical/Data files/Final data files")
...
=======
 wilcox.test (pfs_ok ~ BMI_grouped, correct = FALSE, data = .)
>>>>>>> 23be80055b0c0fe0374172376de91664cc93ad20
...
=======
wilcox.test (os ~ BMI_grouped, correct = FALSE, data = .)
>>>>>>> 23be80055b0c0fe0374172376de91664cc93ad20
...
=======
glimpse(beldf_filtered$pCR_response)
>>>>>>> 23be80055b0c0fe0374172376de91664cc93ad20
```
...
=======
                Lymphnode_status_baseline, Grade_of_tumor, TILs30, TIL_mean, 
>>>>>>> 23be80055b0c0fe0374172376de91664cc93ad20
